...
option = {
	...
	//划线 ==> 上海
	{
		...
		markLine : {
			...
			[{name:'大连'}, {name:'上海',value:80}],
			[{name:'南宁'}, {name:'上海',value:70}],
			[{name:'南昌'}, {name:'上海',value:60}],
			[{name:'拉萨'}, {name:'上海',value:50}],
			[{name:'长春'}, {name:'上海',value:40}],
			[{name:'包头'}, {name:'上海',value:30}],
			[{name:'重庆'}, {name:'上海',value:20}],
